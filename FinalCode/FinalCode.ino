const int leftSpeed =155;
const int rightSpeed = 155;
const int Kp = 25;
const int Ki = 0;
const int Kd = 2;
int m1Speed = 0;
...
// readData();
  ...
  else if ((val1 == LOW && val2 == LOW && val3 == LOW && val4 == LOW && val5 == HIGH) || (val1 == LOW && val2 == LOW && val3 == LOW && val4 == HIGH && val5 == HIGH))
  {
    fast = 75; // LEFT TURN
  ...
  else if ((val1 == HIGH && val2 == LOW && val3 == LOW && val4 == LOW && val5 == LOW) || (val1 == HIGH && val2 == HIGH && val3 == LOW && val4 == LOW && val5 == LOW) /*|| (val1 == HIGH && val2 == HIGH && val3 == LOW && val4 == LOW && val5 == LOW)*/)
  {
    fast = 50; // RIGHT TURN
